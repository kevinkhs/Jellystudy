        ...
        <section className="bg-gradient-primary py-12">
          <div className="container mx-auto px-4">
            <div className="animate-slide-up">
              <h1 className="text-4xl font-bold text-white mb-4">编辑知识点</h1>
              <p className="text-lg text-white/80">更新知识点内容，持续改进你的分享</p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              {submitted && (
                <div className="bg-success/10 border border-success/30 rounded-xl p-6 mb-8 animate-slide-up">
                  <p className="text-success font-bold">✓ 知识点更新成功！</p>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="animate-slide-up">
                ...
                <div className="mb-8">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="详细讲解这个知识点，支持 Markdown 格式"
                    rows={12}
                ...
                <div className="flex gap-4">
                  ...
                  >
                    {submitted ? '✓ 更新成功' : '✓ 更新知识点'}
                  </button>
                  <Link
                    href={`/knowledge/${params.id}`}
